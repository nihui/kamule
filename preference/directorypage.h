...
class DirectoryPageWidget : public PreferenceWidget, public Ui::DirectoryPage, public QECPacketSubscriber
{
public:
    explicit DirectoryPageWidget(QWidget* parent = 0);
    virtual ~DirectoryPageWidget();
